    ...
    <body>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <c:forEach items="${costs }" var="i">                     
                        <tr>
                            <td>
                            	<c:out value="${i.getCostId() }"/>
                            </td>
                            <td><a href="fee_detail.html">
					<c:out value="${i.getName() }"/>
					</a></td>
                            <td>
					<c:out value="${i.getBaseDuration() }"/>
					</td>
                            <td><c:out value="${i.getBaseCost() }"/></td>
                            <td><c:out value="${i.getUnitCost() }"/></td>
                            <td><c:out value="${i.getCreatime() }"/></td>
                            <td><c:out value="${i.getStartime() }"/></td>
