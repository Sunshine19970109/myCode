...
public class DictController {
	...
	public ResponseResult<List<Province>> getProvince(){
		ResponseResult<List<Province>> rr = new ResponseResult<List<Province>>(1,"查询成功");
	...
	public ResponseResult<List<City>> getCity(String provinceCode){
		ResponseResult<List<City>> rr = new ResponseResult<List<City>>(1,"查询成功");
	...
	public ResponseResult<List<Area>> getArea(String cityCode){
		if(cityCode!=null) {
			ResponseResult<List<Area>> rr =new ResponseResult<List<Area>>(1,"查询成功");
