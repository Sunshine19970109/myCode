    ...
    <div class="rightsidebar_box rt">
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_username">
                ...
                <input class="ed_username" value="" style="display: none;" name="username" id="username"/>
                <span class="change_username same_click">${user.username }</span>
            </div>
            <!--性别-->
