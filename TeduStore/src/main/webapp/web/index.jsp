    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
           				<c:forEach varStatus="abc" items="${list2 }">
           								<p>${list2[abc.index].name }</p>
					                <ul>
					                    <c:forEach var="gc" items="${list3[abc.index] }">
        ...
        <div class="item_msg lf">
            <img src="..${goods.image }" alt="" style="width:198px;height:134px"/>

            <p class="bottom_ys2" style="width:198px;height:34px">${goods.title }</p>
