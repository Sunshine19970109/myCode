...
<div class="big">
    ...
    <section id="section" >
        ...
        <div id="box" >
            <div id="content_box">
                ...
                <c:forEach var="cartVo" items="${listVo }">
                <div class="imfor">
                    <div class="check">
                        <div class="Each">
                            <span class="normal">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${cartVo.id }">
                            <img style="width:84px;height:84px" src="..${cartVo.image }" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                            ${cartVo.title }
                              <input type="hidden" name="" value="">
                    ...
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information totalPrice">${cartVo.num*cartVo.price }</span>
                    </div>
                    <div class="del">
                        <!-- <div>
    ...
    <div class="none" style="display: none">
        ...
        <div class="none_content">
            <img src="../images/cart/30.png" alt="" class="lf"/>
